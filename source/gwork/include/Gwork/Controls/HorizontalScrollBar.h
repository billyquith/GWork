...
namespace Gwk
{
    namespace Controls
    {
        class GWK_EXPORT HorizontalScrollBar : public ControlClass<HorizontalScrollBar, BaseScrollBar>
        {
        public:

            HorizontalScrollBar(Gwk::Controls::Base *parent, const Gwk::String &name="");
