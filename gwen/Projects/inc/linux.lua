...
CROSS_LIBS 		= { "UnitTest", "Renderer-OpenGL_DebugFont", "GWEN-Static",
                    "GL", "freeimage" }
...
SFML2_LIBS		= { "UnitTest", "Renderer-SFML2", "GWEN-Static",
                    "sfml-graphics", "sfml-window", "sfml-system", "GL" }
SFML2_LIBS_D	= { "UnitTest", "Renderer-SFML2", "GWEN-Static",
                    "sfml-graphics", "sfml-window", "sfml-system", "GL" }
