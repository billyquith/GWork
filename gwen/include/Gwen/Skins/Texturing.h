    ...
    namespace Skin
    {
        namespace Texturing
        {
            ...
            struct Bordered
            {
                ...
                void Draw(Gwen::Renderer::Base* render, Gwen::Rect r,
                          const Gwen::Color& col = Gwen::Colors::White, bool b1 = true,
                          bool b2 = true, bool b3 = true, bool b4 = true, bool b5 = true,
                          bool b6 = true, bool b7 = true, bool b8 = true, bool b9 = true)
                {
                    ...
                    if (r.w < width && r.h < height)
                    {
                        render->DrawTexturedRect(texture,
                                                 r,
                                                 rects[0].uv[0], rects[0].uv[1], rects[8].uv[2],
                                                 rects[8].uv[3]);
                        return;
                    }
                    ...
                    if (b2)
                    {
                        DrawRect(render, 1, r.x+margin.left, r.y, r.w-margin.left-margin.right,
                                 margin.top);
                    }
                    ...
                    if (b5)
                    {
                        DrawRect(render, 4, r.x+margin.left, r.y+margin.top,
                                 r.w-margin.left-margin.right, r.h-margin.top-margin.bottom);
                    }
                ...
                void DrawRect(Gwen::Renderer::Base* render, int i, int x, int y, int w, int h)
                {
                    render->DrawTexturedRect(texture,
                                             Gwen::Rect(x, y, w,
                                                        h),
                                             rects[i].uv[0], rects[i].uv[1], rects[i].uv[2],
                                             rects[i].uv[3]);
                }
