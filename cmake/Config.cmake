...
if(RENDER_SFML2)
    ...
    if (APPLE)
        set(SFML_DEPENDENCIES ${SFML_DEPENDENCIES} "-framework OpenGL")
    elseif(UNIX)
        set(SFML_DEPENDENCIES ${SFML_DEPENDENCIES}"-lGL")
    elseif(WIN32)
        find_package(OpenGL)
        set(SFML_DEPENDENCIES ${SFML_DEPENDENCIES} ${OPENGL_gl_LIBRARY})
    endif()
    set(GWK_RENDER_INCLUDES "${GLFW_INCLUDE_DIR}")
    set(GWK_RENDER_LIBRARIES ${GLFW_LIBRARIES} ${GLFW_DEPENDENCIES})
